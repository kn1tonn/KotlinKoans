...
fun main() {
    ...
    val findMostExpensiveProductBy = findMostExpensiveProductBy(customer1)

    val getNumberOfTimesProductWasOrdered = shop.getNumberOfTimesProductWasOrdered(milk)

    println(findMostExpensiveProductBy)
    println(getNumberOfTimesProductWasOrdered)
}